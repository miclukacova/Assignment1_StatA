...
We calculate the bias for both approaches:

```{r, echo = FALSE}
tibble(" " = c("Method 1", "Method 2"),
       "Bias" = c(mean(deltasim4$est - fixef(fit2)[4]),
       mean(deltasim5$est - fixef(fit2)[4]))) |> knitr::kable()
```
...
We still obtain the desired coverage and it seems that $\hat{\delta}$ is still an unbiased estimator, regardless of the discretization of the predictor-variables.
