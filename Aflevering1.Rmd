...
So we still obtain the desired coverage and it seems that $\hat{\delta}$ is still an unbiased estimator, no matter whehter we discretize the predictor-variables or not.
